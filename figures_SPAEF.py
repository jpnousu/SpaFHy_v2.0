...
td_may2_top = np.array(results_2d['bucket_moisture_top'][may_ind2,:,:] * soilclass_2).flatten()[sar_flat_ind2]
td_may2_top = td_may2_top[~np.isnan(td_may2_top)]
td_may4_top = np.array(results_2d['bucket_moisture_top'][may_ind2,:,:] * soilclass_4).flatten()[sar_flat_ind4]
td_may4_top = td_may4_top[~np.isnan(td_may4_top)]

td_june2_top = np.array(results_2d['bucket_moisture_top'][jun_ind2,:,:] * soilclass_2).flatten()[sar_flat_ind2]
td_june2_top = td_june2_top[~np.isnan(td_june2_top)]
td_june4_top = np.array(results_2d['bucket_moisture_top'][jun_ind2,:,:] * soilclass_4).flatten()[sar_flat_ind4]
td_june4_top = td_june4_top[~np.isnan(td_june4_top)]

td_july2_top = np.array(results_2d['bucket_moisture_top'][jul_ind2,:,:] * soilclass_2).flatten()[sar_flat_ind2]
td_july2_top = td_july2_top[~np.isnan(td_july2_top)]
td_july4_top = np.array(results_2d['bucket_moisture_top'][jul_ind2,:,:] * soilclass_4).flatten()[sar_flat_ind4]
td_july4_top = td_july4_top[~np.isnan(td_july4_top)]

td_august2_top = np.array(results_2d['bucket_moisture_top'][aug_ind2,:,:] * soilclass_2).flatten()[sar_flat_ind2]
td_august2_top = td_august2_top[~np.isnan(td_august2_top)]
td_august4_top = np.array(results_2d['bucket_moisture_top'][aug_ind2,:,:] * soilclass_4).flatten()[sar_flat_ind4]
td_august4_top = td_august4_top[~np.isnan(td_august4_top)]

td_sept2_top = np.array(results_2d['bucket_moisture_top'][sep_ind2,:,:] * soilclass_2).flatten()[sar_flat_ind2]
td_sept2_top = td_sept2_top[~np.isnan(td_sept2_top)]
td_sept4_top = np.array(results_2d['bucket_moisture_top'][sep_ind2,:,:] * soilclass_4).flatten()[sar_flat_ind4]
td_sept4_top = td_sept4_top[~np.isnan(td_sept4_top)]
...
june2_metrics_top = spaef_metrics(td_june2_top, sar_june2, bins=bins, histrange=histrange)
june4_metrics_top = spaef_metrics(td_june4_top, sar_june4, bins=bins, histrange=histrange)
july2_metrics_top = spaef_metrics(td_july2_top, sar_july2, bins=bins, histrange=histrange)
july4_metrics_top = spaef_metrics(td_july4_top, sar_july4, bins=bins, histrange=histrange)
august2_metrics_top = spaef_metrics(td_august2_top, sar_august2, bins=bins, histrange=histrange)
august4_metrics_top = spaef_metrics(td_august4_top, sar_august4, bins=bins, histrange=histrange)
september2_metrics_top = spaef_metrics(td_sept2_top, sar_sept2, bins=bins, histrange=histrange)
september4_metrics_top = spaef_metrics(td_sept4_top, sar_sept4, bins=bins, histrange=histrange)
...
# min max
minim2 = round(np.nanmin(np.concatenate((sar_june2, sar_july2, sar_august2, sar_sept2, td_june2, td_july2, td_august2, td_sept2))) - 0.05, 1)
maksim2 = round(np.nanmax(np.concatenate((sar_june2, sar_july2, sar_august2, sar_sept2, td_june2, td_july2, td_august2, td_sept2))) + 0.05, 1)
minim4 = round(np.nanmin(np.concatenate((sar_june4, sar_july4, sar_august4, sar_sept4, td_june4, td_july4, td_august4, td_sept4))) - 0.05, 1)
maksim4 = round(np.nanmax(np.concatenate((sar_june4, sar_july4, sar_august4, sar_sept4, td_june4, td_july4, td_august4, td_sept4))) + 0.05, 1)
...
ax1.set_title('MINERAL SOIL')
ax1.set_ylabel('JUNE')
ax1.text(0.15, 3500, f'HM: {june2_metrics_top[0]}')
...
#p = np.poly1d(z)
#ax2.plot(td_june2,p(td_june2),"r--")
ax2.text(0.15, 0.45, f'CC: {june2_metrics_top[1]}')
ax2.text(0.15, 0.40, f'CV: {str(june2_metrics_top[2])}')
ax2.text(0.15, 0.35, f'SPAEF: {june2_metrics_top[3]}')
...
# min max
minim2 = round(np.nanmin(np.concatenate((sar_june2, sar_july2, sar_august2, sar_sept2, td_june2_top, td_july2_top, td_august2_top, td_sept2_top))) - 0.05, 1)
maksim2 = round(np.nanmax(np.concatenate((sar_june2, sar_july2, sar_august2, sar_sept2, td_june2_top, td_july2_top, td_august2_top, td_sept2_top))) + 0.05, 1)
minim4 = round(np.nanmin(np.concatenate((sar_june4, sar_july4, sar_august4, sar_sept4, td_june4_top, td_july4_top, td_august4_top, td_sept4_top))) - 0.05, 1)
maksim4 = round(np.nanmax(np.concatenate((sar_june4, sar_july4, sar_august4, sar_sept4, td_june4_top, td_july4_top, td_august4_top, td_sept4_top))) + 0.05, 1)
...
#gs = gridspec.GridSpec(1, 2)#, width_ratios=[1, 1])#, height_ratios=[1, 1])
#ax1 = plt.subplot(gs[0])
ax1.hist(td_june2_top, bins, alpha=histalpha, label='2D')
ax1.hist(sar_june2, bins, alpha=histalpha, label='SAR')
ax1.set_xlim(minim2, maksim2)
ax1.legend(loc='upper left')
ax1.set_title('MINERAL SOIL')
...
#ax2.scatter(td_june2,st_june2, alpha=0.015)
sns.regplot(ax=ax2, x=td_june2_top[sampl2], y=sar_june2[sampl2], scatter_kws={'s':50, 'alpha':0.1}, line_kws={"color": "red"})
ax2.set_ylim(minim2, maksim2)
ax2.set_xlim(minim2, maksim2)
ax2.set_ylabel('SAR')
ax2.set_xlabel('2D')
...
ax3.hist(td_june4_top, bins, alpha=histalpha, label='obs')
ax3.hist(sar_june4, bins, alpha=histalpha, label='sim')
ax3.set_xlim(minim4, maksim4)
#ax3.legend(loc='upper left')
ax3.set_title('PEAT SOIL')
ax3.text(0.4, 1400, f'HM: {june4_metrics_top[0]}')

#ax4.scatter(td_june4[sampl4],st_june4[sampl4], vmin=0, vmax=1, alpha=0.01)
sns.regplot(ax=ax4, x=td_june4_top[sampl4], y=sar_june4[sampl4], scatter_kws={'s':50, 'alpha':0.1}, line_kws={"color": "red"})
ax4.set_ylim(minim4, maksim4)
ax4.set_xlim(minim4, maksim4)
ax4.set_ylabel('SAR')
ax4.set_xlabel('2D')
ax4.set_title('PEAT SOIL')
ax4.text(0.4, 0.9, f'CC: {june4_metrics_top[1]}')
ax4.text(0.4, 0.85, f'CV: {str(june4_metrics_top[2])}')
ax4.text(0.4, 0.80, f'SPAEF: {str(june4_metrics_top[3])}')

ax5.hist(td_july2_top, bins, alpha=histalpha, label='obs')
ax5.hist(sar_july2, bins, alpha=histalpha, label='sim')
ax5.set_xlim(minim2, maksim2)
#ax5.legend(loc='upper left')
ax5.set_ylabel('JULY')
ax5.text(0.15, 2500, f'HM: {july2_metrics_top[0]}')

#ax6.scatter(td_july2,st_july2, vmin=0, vmax=1,alpha=0.01)
sns.regplot(ax=ax6, x=td_july2_top[sampl2], y=sar_july2[sampl2], scatter_kws={'s':50, 'alpha':0.1}, line_kws={"color": "red"})
ax6.set_ylim(minim2, maksim2)
ax6.set_xlim(minim2, maksim2)
ax6.set_ylabel('SAR')
ax6.set_xlabel('2D')
ax6.text(0.15, 0.45, f'CC: {july2_metrics_top[1]}')
ax6.text(0.15, 0.40, f'CV: {str(july2_metrics_top[2])}')
ax6.text(0.15, 0.35, f'SPAEF: {july2_metrics_top[3]}')

ax7.hist(td_july4_top, bins, alpha=histalpha, label='obs')
ax7.hist(sar_july4, bins, alpha=histalpha, label='sim')
ax7.set_xlim(minim4, maksim4)
#ax7.legend(loc='upper left')
ax7.text(0.4, 400, f'HM: {july4_metrics_top[0]}')

#ax8.scatter(td_july4,st_july4, vmin=0, vmax=1,alpha=0.01)
sns.regplot(ax=ax8, x=td_july4_top[sampl4], y=sar_july4[sampl4], scatter_kws={'s':50, 'alpha':0.1}, line_kws={"color": "red"})
ax8.set_ylim(minim4, maksim4)
ax8.set_xlim(minim4, maksim4)
ax8.set_ylabel('SAR')
ax8.set_xlabel('2D')
ax8.text(0.4, 0.9, f'CC: {july4_metrics_top[1]}')
ax8.text(0.4, 0.85, f'CV: {str(july4_metrics_top[2])}')
ax8.text(0.4, 0.80, f'SPAEF: {july4_metrics_top[3]}')

ax9.hist(td_august2_top, bins, alpha=histalpha, label='obs')
ax9.hist(sar_august2, bins, alpha=histalpha, label='sim')
ax9.set_xlim(minim2, maksim2)
#ax9.legend(loc='upper left')
ax9.set_ylabel('AUGUST')
ax9.text(0.15, 1500, f'HM: {august2_metrics_top[0]}')

#ax10.scatter(td_august2,st_august2, vmin=0, vmax=1,alpha=0.01)
sns.regplot(ax=ax10, x=td_august2_top[sampl2], y=sar_august2[sampl2], scatter_kws={'s':50, 'alpha':0.1}, line_kws={"color": "red"})
ax10.set_ylim(minim2, maksim2)
ax10.set_xlim(minim2, maksim2)
ax10.set_ylabel('SAR')
ax10.set_xlabel('2D')
ax10.text(0.15, 0.45, f'CC: {august2_metrics_top[1]}')
ax10.text(0.15, 0.40, f'CV: {str(august2_metrics_top[2])}')
ax10.text(0.15, 0.35, f'SPAEF: {str(august2_metrics_top[3])}')

ax11.hist(td_august4_top, bins, alpha=histalpha, label='obs')
ax11.hist(sar_august4, bins, alpha=histalpha, label='sim')
ax11.set_xlim(minim4, maksim4)
#ax11.legend(loc='upper left')
ax11.text(0.4, 1500, f'HM: {august4_metrics_top[0]}')

#ax12.scatter(td_august4,st_august4, vmin=0, vmax=1,alpha=0.01)
sns.regplot(ax=ax12, x=td_august4_top[sampl4], y=sar_august4[sampl4], scatter_kws={'s':50, 'alpha':0.1}, line_kws={"color": "red"})
ax12.set_ylim(minim4, maksim4)
ax12.set_xlim(minim4, maksim4)
ax12.set_ylabel('SAR')
ax12.set_xlabel('2D')
ax12.text(0.4, 0.9, f'CC: {august4_metrics_top[1]}')
ax12.text(0.4, 0.85, f'CV: {str(august4_metrics_top[2])}')
ax12.text(0.4, 0.80, f'SPAEF: {str(august4_metrics_top[3])}')


ax13.hist(td_sept2_top, bins, alpha=histalpha, label='obs')
ax13.hist(sar_sept2, bins, alpha=histalpha, label='sim')
ax13.set_xlim(minim2, maksim2)
#ax9.legend(loc='upper left')
ax13.set_ylabel('SEPTEMBER')
ax13.text(0.15, 2500, f'HM: {september2_metrics_top[0]}')

#ax14.scatter(td_sept2,st_sept2, vmin=0, vmax=1,alpha=0.01)
sns.regplot(ax=ax14, x=td_sept2_top[sampls2], y=sar_sept2[sampls2], scatter_kws={'s':50, 'alpha':0.1}, line_kws={"color": "red"})
ax14.set_ylim(minim2, maksim2)
ax14.set_xlim(minim2, maksim2)
ax14.set_ylabel('SAR')
ax14.set_xlabel('2D')
ax14.text(0.15, 0.45, f'CC: {september2_metrics_top[1]}')
ax14.text(0.15, 0.40, f'CV: {str(september2_metrics_top[2])}')
ax14.text(0.15, 0.35, f'SPAEF: {september2_metrics_top[3]}')

ax15.hist(td_sept4_top, bins, alpha=histalpha, label='obs')
ax15.hist(sar_sept4, bins, alpha=histalpha, label='sim')
ax15.set_xlim(minim4, maksim4)
#ax11.legend(loc='upper left')
ax15.text(0.4, 650, f'HM: {september4_metrics_top[0]}')

#ax16.scatter(td_sept4,st_sept4, vmin=0, vmax=1,alpha=0.01)
sns.regplot(ax=ax16, x=td_sept4_top[sampls4], y=sar_sept4[sampls4], scatter_kws={'s':50, 'alpha':0.1}, line_kws={"color": "red"})
ax16.set_ylim(minim4, maksim4)
ax16.set_xlim(minim4, maksim4)
ax16.set_ylabel('SAR')
ax16.set_xlabel('2D')
ax16.text(0.4, 0.9, f'CC: {september4_metrics_top[1]}')
ax16.text(0.4, 0.85, f'CV: {str(september4_metrics_top[2])}')
ax16.text(0.4, 0.80, f'SPAEF: {september4_metrics_top[3]}')

plt.tight_layout()
ax1.grid(); ax2.grid(); ax3.grid(); ax4.grid(); ax5.grid(); ax6.grid(); ax7.grid(); ax8.grid()
ax9.grid(); ax10.grid(); ax11.grid(); ax12.grid(); ax13.grid(); ax14.grid(); ax15.grid(); ax16.grid()

plt.savefig(f'SCATTERHIST_SAR_SPATOP_{today}.png')
